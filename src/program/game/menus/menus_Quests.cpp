...
namespace rr {
    ...
    Quests::Quests()
        : wQues_ (Window(resources.dictionary["gui.window.quests"], sf::Vector2f(725, 470),
...
#define component(w, c, i) w.getComponent<c>(i)
            ...
            component(wQues_, Button, 0)->setPosition(sf::Vector2f(wQues_.getPosition().x+wQues_.getSize().x-component(wQues_, Button, 0)->getSize().x-15,
                                                                  settings.graphics.resolution.y/2+225-component(wQues_, Button, 0)->getSize().y-5));
