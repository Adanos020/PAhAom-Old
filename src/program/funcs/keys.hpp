...
namespace rr
{
    ...
    ////////////////////////////////////////////////////////////////////////
    inline bool
    isKeyPressed(sf::Keyboard::Key key)
    {
    ...
    ////////////////////////////////////////////////////////////////////////
    inline bool
    wasKeyPressed(sf::Event& event, sf::Keyboard::Key key)
    {
    ...
    ////////////////////////////////////////////////////////////////////////
    inline sf::String
    getKeyName(sf::Keyboard::Key keyCode)
    {
        switch (keyCode)
        {
    ...
    ////////////////////////////////////////////////////////////////////////
    inline sf::Keyboard::Key
    getKeyCode(sf::String keyName)
    { // I would use a switch here if C++ allowed me to switch the sf::String objects
