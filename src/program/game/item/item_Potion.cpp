...
namespace rr {
    ...
    Potion::Potion(Effect e, Size s, int am, sf::Vector2f pos) {
        ...
        body[0].texCoords = sf::Vector2f( tu*14+0.0625f   ,  tv*14+0.0625f   );
        body[1].texCoords = sf::Vector2f((tu+1)*14-0.0625f,  tv*14+0.0625f   );
        body[2].texCoords = sf::Vector2f((tu+1)*14-0.0625f, (tv+1)*14-0.0625f);
        body[3].texCoords = sf::Vector2f( tu*14+0.0625f   , (tv+1)*14-0.0625f);
