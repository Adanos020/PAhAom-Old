...
namespace rr {
    ...
    MainMenu::MainMenu(sf::RenderWindow& rw) {
        ...
        wMenu = new Window(nullptr, L"", sf::Vector2f(244, 454), sf::Vector2f(25, rw.getSize().y/2-225));
            wMenu->addComponent(new Button(wMenu, sf::Vector2f(0, 5), dict("button.newgame"), 52));
            wMenu->addComponent(new Button(wMenu, sf::Vector2f(0, 80), dict("button.load"), 52));
            wMenu->addComponent(new Button(wMenu, sf::Vector2f(0, 155), dict("button.options"), 52));
            wMenu->addComponent(new Button(wMenu, sf::Vector2f(0, 230), dict("button.help"), 52));
            wMenu->addComponent(new Button(wMenu, sf::Vector2f(0, 305), dict("button.credits"), 52));
            wMenu->addComponent(new Button(wMenu, sf::Vector2f(0, 380), dict("button.quit"), 52));
            for (int i=0; i<6; i++)
