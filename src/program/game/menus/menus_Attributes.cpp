...
#define component(w, c, i) w->getComponent<c>(i)
        ...
        wAttr = new Window(dictionary.gui.window.attributes, sf::Vector2f(900, 300), (sf::Vector2f)rw.getSize()/2.f-sf::Vector2f(450, 150));
            ...
            wAttr->addComponent(new Text(sf::Vector2f(400, 25), "", resources.font.Unifont, 30, sf::Color::Green) , true);             // values
            wAttr->addComponent(new Text(sf::Vector2f(600, 25), "", resources.font.Unifont, 30, sf::Color::Yellow), true);             // skills
