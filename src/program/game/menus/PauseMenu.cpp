...
namespace rr {
    ...
    PauseMenu::PauseMenu(sf::RenderWindow& rw) {
        ...
        wMenu = new Window("", sf::Vector2f(325, 454), sf::Vector2f(25, rw.getSize().y/2-225));
            wMenu->addComponent(new Button(sf::Vector2f(5, 5), dict("button.resume"), 52));
            wMenu->addComponent(new Button(sf::Vector2f(5, 80), dict("button.save"), 52));
            wMenu->addComponent(new Button(sf::Vector2f(5, 155), dict("button.load"), 52));
            wMenu->addComponent(new Button(sf::Vector2f(5, 230), dict("button.options"), 52));
            wMenu->addComponent(new Button(sf::Vector2f(5, 305), dict("button.help"), 52));
        ...
        wHelp = new Window(dict("button.help"), sf::Vector2f(325, 454), sf::Vector2f(rw.getSize().x-350, rw.getSize().y/2-225));
            wHelp->addComponent(new Text(dict("Protip:"), sf::Vector2f(20, 25), 30, sf::Color::Yellow));
